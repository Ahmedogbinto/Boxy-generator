...
export default function ModalResult({closeModal}) {
    ...
    // fonction pour gérer l'animation et eviter le spam du mot copy
    let runningAnnimation = false;
    function handleCopy(e){
        if(!runningAnnimation){
            runningAnnimation = true
            e.target.textContent = "Copied !"

            setTimeout(()=> {
                e.target.textContent = "Copy"
                runningAnnimation = false
            }, 1250)
        }
  ...
  return (
    ...
    >
        ...
        >
            ...
            <p className="rounded bg-gray-100 p5">
